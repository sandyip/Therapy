<?php get_header('1');
/*Template Name: Information Session Page*/
?>
        ...
        <div class="col-lg-4 col-md-12">
         <!--  <div class="services-details-info">
            <ul class="services-list">
              <li><a href="<?php echo site_url('/teens-consultation');?>" class="active">Teens Consultation <i class="flaticon-imagination"></i></a></li>
              <li><a href="<?php echo site_url('/couple-consultation');?>">Couple Consultation <i class="flaticon-bipolar"></i></a></li>
              <li><a href="<?php echo site_url('/one-to-one-consultation');?>">One To One Consultation <i class="flaticon-brain"></i></a></li>
              <li><a href="<?php echo site_url('/family-consultation');?>">Family Consultation <i class="flaticon-extrovert"></i></a></li>
            </ul>
